...
> **Governance Notice** — This pack is governed by the [Stella Maris Constitution (CONST-01)](https://github.com/stella-maris-governance/smg-enterprise-hq) and enforces **POL-AC-01 (Access Control) · NIST IA-2, AC-17**. All dispositions are subject to the Two-Person Integrity Protocol.
